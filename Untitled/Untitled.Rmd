...
After installation, the instance creation is the second step.
...
The instance created is called "OFD," an acronym from "Online Food Delivery." Figure [3](#fig:F3) depicts this instance which by default is "stopped." The user should start the instance by clicking the button "Start instance" that is at the top right of the window.
...
According to @segura2019, this database was developed with the goal of evaluating the impact of traffic conditions on key performance indicators of a sample of 787 restaurants with food delivery services in Bogotá City.
It includes the physical location of both restaurants and 4,296 customers, as well as key performance indicators and traffic descriptions captured by the Google Maps API at three time points during Saturday rush hours.
...
By using letter triads they characterized the typical daily traﬃc.
Thus, for example, the sequence “R-O-G” means that the typical traﬃc changes from “red” in the morning to “orange” at noon and “green” in the afternoon, describing a place where traﬃc conditions improve as time passes.
