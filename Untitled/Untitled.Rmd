...
# Implications of graph databases for psychological research
...
The data import is straightforward using the import option depicted with a red circle in the left panel of neo4j (see Figure [3](#fig:F4)).
...
Despite the simplistic structure of the graph database model of Figure [4](#fig:F5), its complexity and scope can easily grow as long as the analyst intends to map other variable relationships.
