...
One of the easiest way to grasp the idea of a network is by looking its visual representation.
Figure [1](#fig:F1) shows the visual representations of four types of simple networks.

```{r F1, echo=FALSE, fig.cap="A visual representation of four types of simple networks", fig.align="center", out.width="227px", fig.pos="H"}
knitr::include_graphics("/home/jcc/Documents/GitHub/NOSQLINBS/F1.png")
```

![Figure 1. A visual representation of four types of simple networks: non-directed unweighted network (upper left), non-directed weighted network (upper right), di- rected unweighted network (bottom left), and directed weighted network (bottom right).](images/F1-01.png){#fig:F1 width="50%" fig-pos="H"}
...
The fundamental concepts of network science are helpful to explore nodes connections within the network and understand the structure of these links.
