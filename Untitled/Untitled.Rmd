...
In this context, the term "social network" should not be confused with Instagram or Facebook, as they are online platforms that have nothing to do with social networks as an object of study.

Psychologists have leveraged the framework of network science to 
Even though these examples show the utility of network science for psychological research, they do not rely on graph database management systems. This aspect is what differentiates this article from previous works. Here, I intend to illustrate how LPGs unveil novel ways for modeling and analyzing behavioral and psychological data.
