...
For example, figure [5](fig:F5) shows that the number of connections between restaurants and customers is uneven when considering distances less than or equal to 2,000 meters (i.e., some restaurants have more clients than others).
...
Self-organization is widely recognized in natural sciences such as physics or biology, but in psychology is largely neglected or underexplored [@correa2020].
