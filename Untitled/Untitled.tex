...
\title[Graph Databases]{An introductory tutorial of labeled property
graphs for psychological data}
...
representing complex psychological data structures, such as multilevel
designs, longitudinal assessments, and dynamic networks. This tutorial
introduces graph databases and their labeled property graphs as an
alternative to relational databases, illustrating how they enable
efficient modeling of interconnected psychological phenomena. We provide
a step-by-step guide for implementing property graphs using Neo4j,
including schema design, query patterns, and integration with R/Python
for analysis. Practical examples drawn from open psychological datasets
demonstrate performance and flexibility gains over traditional
relational approaches. Reproducible materials, including code and data,
are available via OSF to facilitate adoption and replication.}
...
platforms such as Instagram or Facebook, as they are technological
implementations that do not necessarily represent all aspects of social
networks as an object of study. Psychologists have leveraged this
framework to analyze the structure of psychopathology
\citep{borsboom2013}, conduct bibliometric analysis of cyberbehavior
\citep{serafin2019}, estimate the correct number of dimensions in
psychological and educational instruments \citep{golino2017}, or
understand the measurement of organizational climate
\citep{menezes2021}. Even though these examples show the versatility of
social network analysis for psychological research, they do not
necessarily rely on graph database management systems and this aspect is
what differentiates this article. Here, I intend to illustrate how the
network lenses, when applied as a database management system, unveils
novel ways for modeling and analyzing behavioral data.
...
article aims to illustrate how graph databases can enrich the
methodological toolbox of psychological researchers and behavioral
...
database management systems represent a relevant methodological tool for
behavioral sciences. I will elaborate upon these implications
immediately.

\section{Methodological implications of graph
databases}\label{methodological-implications-of-graph-databases}
...
An important methodolgical implication embedded in graph database models
is their performance when handling connected data compared to relational
databases that rely on tabular structures \citep{Robinson2015}. In
...
with millions of nodes and edges. From a traditional perspective, the
idea of working with huge datasets might seem implausible for most
psychological researchers. Nonetheless, big data research is no longer
outside professional considerations \citep{vezzoli2023}. Such
considerations, however, have been tackled by network scientists in
charge of analyzing urban traffic at an individual level by tracking the
...
public GitHub repository. By default any instance created in neo4j is
``stopped'' mode and the user should start it by clicking one button.
