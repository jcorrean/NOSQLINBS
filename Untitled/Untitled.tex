...
examples include the analyses of the structure of psychopathology
\citep{borsboom2013}, the bibliometric approach to cyberbehavior
\citep{serafin2019}, the psychometric estimation of the correct number
of dimensions in psychological and educational instruments
\citep{golino2017}, or the measurement of organizational climate
\citep{menezes2021}.

Despite the relational nature of psychological data, a significant
amount of psychological research relies on structured data which are
managed through relational databases with their standardized
``structured query language'' (SQL) which is the dominant database
paradigm in research and industry \citep{soto2025}. An alternative
database paradigm is the so-called ``Not Only SQL'' (NoSQL). This later
paradigm includes database systems that employ non-tabular data models,
such as key-value pairs, documents, wide columns, matrices, and graphs.
Whereas relational databases store structured data in tables (i.e.,
columns as variables, rows as cases, and cells containing specific
values), NoSQL systems accommodate flexible formats that better support
evolving and highly connected data, which provides distinct advantages
in psychological research. In this article, I examine graphs as a
database paradigm that deviates from the traditional lenses of
relational databases, where nodes and edges (instead of tables and
joins) represent the basic elements of any behavior that can be
represented as a network or a complex system.
