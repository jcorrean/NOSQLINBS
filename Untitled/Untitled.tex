...
rigor of findings in subsequent statistical analyses. The problem with
omitted variables in statistical modeling is recognized as one of the
culprits of endogeneity in making causal claims out of non-experimental
research \citep{antonakis2010}. The problem of omitted variables remains
as a valid concern for most recent statistical techniques as they convey
other circumstances \citep{bollen2019}. From a technical viewpoint,
several reasons may explain why researchers omit one or more variables
in a model. In some cases, operational costs for capturing or measuring
