...
relationship ``SERVES'' has one property (i.e., distance). Despite its
simple visual representation, with this model we can examine several
statistical aspects. For example, by using cypher, which is Neo4j's
declarative, SQL-like query language for property graphs, the following
syntax provides the minimum, the mean, and the maximum distance coverage
