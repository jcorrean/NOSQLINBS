...
\section{Implications of graph databases for psychological
research}\label{implications-of-graph-databases-for-psychological-research}
...
\hyperref[fig:F5]{4}, its complexity and scope can easily grow as long
...
\href{fig:F6}{5}. Such a network-based data structure visualization
...
{\centering \includegraphics[width=380px,height=200px,]{../F6} 

}

\caption{A network-based visualization of the Restaurant-SERVES-Customer graph model}\label{fig:F6}
\end{figure}
