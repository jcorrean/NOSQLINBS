...
\title[Graph Databases]{Leveraging Graph Databases to Model Complex
Behavioral Systems}
...
by using cypher, which is Neo4j's declarative, SQL-like query language
for property graphs, the following syntax provides the minimum, the
